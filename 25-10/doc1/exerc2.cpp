/*
02) Criar um algoritmo para preencher com valores numéricos uma matriz 3 x 3 
e que em seguida exiba na tela os elementos que não fazem parte da diagonal principal.
*/
